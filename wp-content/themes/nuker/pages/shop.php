...
foreach( $my_posts as $post ){
	setup_postdata( $post );
	?>
	<div class='minified__card'><img src="<?php the_field('kartinka_tovara'); ?>" alt=""><div class='minified__info'><h2><?php the_title(); ?></h2><p><?php the_field('opisanie_tovara'); ?></p><a href="<?php echo get_permalink(); ?>">Подробнее</a></div></div>
	<?php
}
