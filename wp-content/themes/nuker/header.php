...
<body>
    ...
    <header class="header">
        <div class="container container__spec">
            <div class="header__wrapper active__header">
				<style>
		html {
			margin-top: 0px !important;
                ...
                <img class="hide" src="<?php echo esc_url( get_template_directory_uri() ); ?>/src/img/logo_white.svg" alt="">
                <?php wp_nav_menu()?>
				...
				<div class="language activated__menu" style="display: none;">
