...
<body>
    ...
    <header class="header__main">
        <div class="container container__spec">
...
/* 					.show__logoww{
					...
					img.logo__sticky.logo__stickyy{
						display: none;	
					}
					.show__logos{
						display: none
					...
					img.logo__white.show__logoww.show__logow{
						display: none !important
					}
				</style>
                <img class="logo__sticky logo__stickyy" src="<?php echo esc_url( get_template_directory_uri() ); ?>/src/img/logo.svg " alt="">
                <img class="logo__white show__logoww" src="<?php echo esc_url( get_template_directory_uri() ); ?>/src/img/logo_white.svg" alt="">
                <?php wp_nav_menu()?>
				...
				<div class="language" style="display: none;">
                    <a class="active__lang">RU</a>
                    <a href="https://nuker.kz/kk" class="none__active" style="display: inline;">KZ</a>
                    <a href="https://nuker.kz/en" class="none__active" style="display: inline;">EN</a>
                </div>
            </div>
			 <div class="language language__selected">
                    <a  class="active__lang">RU</a>
                    <a href='http://nuker.kz/kk'  class="none__active">KZ</a>
                    <a href='http://nuker.kz/en' class="none__active">EN</a>
                </div>
        </div>
    </header>
		<script>
    
//     document.querySelector('.top__bg').scrollIntoView({
//         behavior: 'smooth',
//         block: 'start'
//     });
	...
	document.addEventListener( 'DOMContentLoaded', ()=>{
		...
		document.querySelector('.menu-item-103').scrollIntoView({
			behavior: 'smooth',
			block: 'start'
		});
