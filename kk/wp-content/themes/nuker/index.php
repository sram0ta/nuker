...
<section class="section1">  
        <div class="container">
            ...
            <a class="btn__top__main" href="">Хат жазу</a>  
        </div>
		<picture>
...
// переменные
				...
				if( $card1 ): ?>
					<a href="https://nuker.kz/kk/produkcziya/#ZPU">
...
// переменные
				...
				if( $card2 ): ?>
					<a href="https://nuker.kz/kk/produkcziya/#PU">
...
// переменные
				...
				if( $card3 ): ?>
					<a href="https://nuker.kz/kk/produkcziya/#NOZH">
    ...
    <section class="section4">
        <div class="container">
            <div class="map" style='background: url{}'>
                ...
                <a><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/src/img/logo-map.svg" alt=""><p>Ақтөбе</p></a>
    ...
    <button><a href='https://nuker.kz/kk/dokumenty-2/' style='color:#3399DB;'>Патенттер</a></button>
    <button><a href='https://nuker.kz/kk/dokumenty-2/'style='color:white;'>Сертификаттар</a></button>
</div>
</div>
    <section class="section4" style='margin-bottom:70px;'>
        <div class="container">
            <h2>Біздің клиенттер</h2>
