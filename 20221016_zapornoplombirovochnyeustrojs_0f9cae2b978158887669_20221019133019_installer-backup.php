...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221016_zapornoplombirovochnyeustrojs_0f9cae2b978158887669_20221019133019_archive.zip';
        const ARCHIVE_SIZE       = '214951571';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '0f9cae2-19133019';
        const SECONDARY_PACKAGE_HASH = '8fca530-19133019';
        const VERSION            = '1.5.0';
